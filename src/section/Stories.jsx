...
function Stories() {
    return (
        <section
            id="stories"
            className="lg:py-16 md:py-12 py-8 px-8 md:px-16 lg:px-24 xl:px-40 bg-white"
        >
            {/* Section Heading */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
                {data.map((item) => (
                    <div
                        key={item.id}
                        className="group bg-gray-100 rounded-md shadow-sm overflow-hidden text-center cursor-pointer transition-shadow duration-300 hover:shadow-2xl"
                    >
                        {/* Image Wrapper */}
